...
#params<-list(path="/home/cahaisv/git/methylkey/bin/",  meth="methylkey/meth.rdata",  variables="tissue",  batch="None",  correction="sva",  nalimit=0.2,  missing="mean", separator=",", out="methylkey")
...
write("2- Check variables",file=paste0(params$out,"/log"))
...
write("3- Create Model",file=paste0(params$out,"/log"))
...
#3-check mvalues
write("3- Check mvalues",file=paste0(params$out,"/log"))
...
```{r sva, eval=(params$correction=="sva"), include=FALSE}
 #4-Batch correction
write("4- SVA correction",file=paste0(params$out,"/log"))
...
```{r ssva, eval=(params$correction=="ssva"), include=FALSE}
 #4-Batch correction
write("4- Smart SVA correction",file=paste0(params$out,"/log"))
require(SmartSVA)
...
write("4- Combat correction",file=paste0(params$out,"/log"))
require(sva)
...
```{r PCA, include=FALSE}
write("5- running PCA",file=paste0(params$out,"/log"))
...
write("6- Save results",file=paste0(params$out,"/log"))
