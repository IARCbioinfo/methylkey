...
source( paste0(params$path, "/loader.r")  )
...
#1- load pdata
write("1- Loading data",file=paste0(params$out,"/log"),append = TRUE)
...
write("2- Sanitize variables",file=paste0(params$out,"/log"),append = TRUE)
...
#3- check samples
write("3- Check samples",file=paste0(params$out,"/log"),append = TRUE)
tryCatch({
...
#check barcode
write("4- Check barcode",file=paste0(params$out,"/log"),append = TRUE)
tryCatch({
...
#5- check groups
write("5- Check groups",file=paste0(params$out,"/log"),append = TRUE)
for (group in groups) {
  tryCatch({
...
#6- read idat
write("6- Read idat", file=paste0(params$out,"/log"), append=TRUE)
...
#7-check gender
write("7- Check gender",file=paste0(params$out,"/log"),append = TRUE)
...
write("8- QC before processing : boxplots1",file=paste0(params$out,"/log"),append = TRUE)
nsamp<-nrow(pdata)
...
write("9- QC before processing : plotQC1",file=paste0(params$out,"/log"),append = TRUE)
...
write("10- QC before processing : densityPlot, densityBeanPlot, mdsPlot",file=paste0(params$out,"/log"),append = TRUE)
...
#11- Houseman
write("11- Houseman",file=paste0(params$out,"/log"),append = TRUE)
pdata<-houseman(RGset, data, platform, params$out)
```

```{r normalization, include=FALSE}
#12- Normalization
write("12- Normalization",file=paste0(params$out,"/log"),append = TRUE)
rawbetas=betas
...
#12- Filter by pvalue
write("12- Filterbypvalue",file=paste0(params$out,"/log"),append = TRUE)
...
write("13- Restaure NA status",file=paste0(params$out,"/log"),append = TRUE)
...
write("13- Filter probes from list",file=paste0(params$out,"/log"),append = TRUE)
probes=c()
for (file in filters){
  if(file.exists(file)){
...
write(paste0("15- Filter NA values : ", params$nalimit),file=paste0(params$out,"/log"),append = TRUE)
...
write(paste0("16- remove selected probes : ", params$nalimit),file=paste0(params$out,"/log"),append = TRUE)
...
write(paste0("17- Remove missing values : ", params$missing),file=paste0(params$out,"/log"),append = TRUE)
...
#18- QC before processing : plotQC1
write("18- QC After processing : plotQC2",file=paste0(params$out,"/log"),append = TRUE)
qc <- getQC(MSet)
...
write("19- QC after processing : density plot, densitybeanplot, mdsplot" ,file=paste0(params$out,"/log"),append = TRUE)
for (group in groups) {
...
```{r PCA, include=FALSE}
#20- PCA
write("20- PCA" ,file=paste0(params$out,"/log"),append = TRUE)
...
#21- DeltaBetas
write("21- Calculate Delta Betas" ,file=paste0(params$out,"/log"),append = TRUE)
deltab<-""
...
#22-violin plot
write("22- Draw violin plots" ,file=paste0(params$out,"/log"),append = TRUE)
...
#23- mvalues
write("23- Calculate mvalues" ,file=paste0(params$out,"/log"),append = TRUE)
mval=beta2m(betas)
...
write("24- Save results" ,file=paste0(params$out,"/log"),append = TRUE)
...
write("25- Markdown report" ,file=paste0(params$out,"/log"),append = TRUE)
```
...
### [ QC after normalization ](`r params$out`/plotQC2.jpg)

```{r, echo=FALSE}
  knitr::include_graphics(paste0(params$out,"/plotQC2.jpg"))
```
