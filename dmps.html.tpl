...
<table>
<tr><td><h3>QQplot</h3> Lambda = {{ lambda }}<br/></td>
<td><h3>Heatmap of 50 more differentially methylated probes</h3></td>
<td><h3>Circus plot</h3></td>
</tr>
<tr>
<td><a href="{{ out }}/{{ process_id }}/qqplot.jpg"  ><img src="{{ out }}/{{ process_id }}/qqplot.jpg"/></a></td>
