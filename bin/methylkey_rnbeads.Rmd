...
```{r PCA, include=FALSE}
#10- PCA
write("10- PCA" ,file=paste0(params$out,"/log"),append = TRUE)
...
#11- DeltaBetas
write("11- Calculate Delta Betas" ,file=paste0(params$out,"/log"),append = TRUE)
deltab<-""
...
#12-violin plot
write("12- Draw violin plots" ,file=paste0(params$out,"/log"),append = TRUE)
...
#13- mvalues
write("13- Calculate mvalues" ,file=paste0(params$out,"/log"),append = TRUE)
mval=beta2m(betas)
...
write("14- Save results" ,file=paste0(params$out,"/log"),append = TRUE)
...
write("15- Markdown report" ,file=paste0(params$out,"/log"),append = TRUE)
```
