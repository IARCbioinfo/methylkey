...
```{r, results='asis'}
	...
	for (group in params$groups) {
	  ...
	  cat("|![](", paste0(params$project, "/", group, "/densityPlot1.jpg)","|"))
	  cat("![](", paste0(params$project, "/", group, "/densityPlot2.jpg)","|\n"))
	  
	  cat("|![](", paste0(params$project, "/", group, "/densityBeanPlot1.jpg)","|"))
	  cat("![](", paste0(params$project, "/", group, "/densityBeanPlot2.jpg)","|\n"))
	  
	  cat("|![](", paste0(params$project, "/", group, "/mdsPlot1.jpg)","|"))
	  cat("![](", paste0(params$project, "/", group, "/mdsPlot2.jpg)","|\n"))
